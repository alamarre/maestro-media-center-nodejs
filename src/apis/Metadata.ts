...
export default class MetadataApi {
  constructor(private metadataProvider) {
  }
  async getImage(ctx) {
  ...
  init(router) {
    router.get("/image", this.getImage.bind(this));
    router.get("/movie/:movieName", this.getMovieMetadata.bind(this));
    router.get("/tv/:show", this.getTvShowMetadata.bind(this));
    router.get("/tv/:show/:season", this.getTvSeasonMetadata.bind(this));
    router.get("/tv/:show/:season/:episode", this.getTvEpisodeMetadata.bind(this));
  }
}
