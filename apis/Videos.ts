...
export class VideosApi {
  ...
  public get(req: Request, res: Response, next: NextFunction) {
    ...
    let stat : Stats = fs.lstatSync(listing);
    let stream : ReadStream = fs.createReadStream(listing);
  ...
  private sendSeekable (stream : ReadStream, type: string, length: number, req: Request, res: Response, next: NextFunction) 
  {
